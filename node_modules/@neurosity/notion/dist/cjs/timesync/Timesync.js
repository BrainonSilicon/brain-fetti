...
class Timesync {
    ...
    starTimer() {
        ...
        const timer$ = rxjs_1.timer(updateInterval, updateInterval).pipe(operators_1.map(i => bufferSize + i));
        burst$
            .pipe(operators_1.concat(timer$), this.toOffset(), operators_2.bufferCount(bufferSize, 1), this.filterOutliers(), operators_1.map(list => this.average(list)))
            .subscribe(offset => {
            this._offset = offset;
        });
    }
